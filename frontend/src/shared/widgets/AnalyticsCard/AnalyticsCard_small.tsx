...
const AnalyticsCard_small = ({icon: Icon, title, text, icon_bgColor, icon_color}: AnalyticsCard_smallProps) => {
    return (
        <section className="bg-white w-full sm:w-[300px] min-h-[120px] sm:h-[150px] border-3
        border-[#c8d69b] shadow-md flex flex-col justify-center p-4 sm:p-5 rounded-[15px]">
